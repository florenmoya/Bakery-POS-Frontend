<template>
    <v-data-table v-model="selected" dense :search="search" :headers="headers" :items="items" :items-per-page="items_per_page" v-bind:show-select="show_select" :loading="loading" multi-sort>
        <template v-slot:top>
...
export default {
    props: ['headers', 'items', 'items_per_page', 'selectedData', 'single-select', 'show_select', 'loading', 'cart_name'],
    data() {
        return {
            search: '',
